...
<head>
  ...
  <style type="text/css">
    ...
    td,th,p,a,span {{font-family:Arial,Helvetica,sans-serif !important;}}
  </style>
  <noscript>
  <xml>
...
<body style="margin:0;padding:0;word-spacing:normal;
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
         border="0" style="background-color:#f1f5f9">
    <tr>
      <td align="center" class="wrapper" style="padding:24px 12px">
        <!-- 内层主容器：max-width 600px，居中 -->
        <table role="presentation" width="600" cellpadding="0"
          ...
          <!-- BODY -->
          <tr>
            <td style="background-color:#ffffff;padding:12px 0 8px">
